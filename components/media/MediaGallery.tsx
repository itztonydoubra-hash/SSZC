  ...
  return (
    <>
        ...
        {items.map((m, i) => (
          <figure className="pg-media__item" key={m.src}>
            <button
              ...
              onClick={() => setOpen(i)}
            >
              <span style={{ display: "block", position: "relative", aspectRatio: m.ratio }}>
      ...
      {active && (
        ...
        >
          <div style={{ position: "relative", maxWidth: "min(90vw, 1200px)", maxHeight: "85vh", width: "100%", aspectRatio: active.ratio }}>
